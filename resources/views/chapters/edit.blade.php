        ...
        <form id="add-story-form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input value="{{ $chapter->chapter_title }}" type="text" class="form-control" id="title"
                    name="chapter_title" required>
                <div class="invalid-feedback"></div>
            </div>

            <div class="form-group">
                <label for="content">Content:</label>
                <textarea class="form-control" id="story_chapter" name="story_chapter">{{ $chapter->story_chapter }}</textarea>
            </div>
    ...
    <script>
        ...
        form.addEventListener('submit', async (event) => {
            ...
            const response = await fetch(
                '/stories/{{ $chapter->story_id }}/chapters/{{ $chapter->id }}?_method=put', {
                    method: 'POST',
                    body: formData
                });
